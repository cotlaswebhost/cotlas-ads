...
- Same-dimension image slider creatives with adjustable intervals
...
- Native WordPress Update URI discovery with force-check cache invalidation
- Automatic immutable placement slugs and improved searchable assignment filtering
- Ad-block detection that checks both a bait element and real creative visibility
...
These are not represented as complete in 0.3.4 and should be developed against explicit newsroom requirements rather than copied from a third-party implementation:
