...
define('COTLAS_ADS_VERSION', '0.5.10');
...
// Schema and role upgrades may translate role labels, so run them at init or later.
add_action('init', array('Cotlas_Ads_Install', 'maybe_upgrade'), 1);
